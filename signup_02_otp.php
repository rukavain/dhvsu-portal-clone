...
if (!isset($_SESSION['gatepass']) || $_SESSION['gatepass'] !== 'signup_02') {
    header("Location: signup_01.php");
...
<body>
    ...
    <div class="container col-md-10 mx-auto col-lg-5  pt-5">
        <form action="signup_02a_process.php" method="post" class="p-4 p-md-5 border rounded-3 bg-body-tertiary h-100 ">
